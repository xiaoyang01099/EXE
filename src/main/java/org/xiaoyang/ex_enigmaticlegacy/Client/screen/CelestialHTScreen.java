...
public class CelestialHTScreen extends AbstractContainerScreen<CelestialHTMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("screen.ex_enigmaticlegacy.celestia_ht.name"), 11, 6, -6684673);
		String timePro = this.menu.getRecipeTimePro();
		if (Float.parseFloat(timePro) > 0) {
			guiGraphics.drawString(this.font, timePro, 90, 20, 4210752);
			guiGraphics.drawString(this.font, "%", 110, 20, 4210752);
		}
	}
