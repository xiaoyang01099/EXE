package org.xiaoyang.ex_enigmaticlegacy.Client.model;
...
import org.xiaoyang.ex_enigmaticlegacy.Compat.Botania.Block.render.RenderTileManaCharger;
import org.xiaoyang.ex_enigmaticlegacy.Compat.Botania.Block.tile.ManaChargerTile;
...
public class ModelManaCharger extends Model {
    ...
    public void render(RenderTileManaCharger render, PoseStack matrixStack, double time) {
        ...
        matrixStack.mulPose(Axis.YP.rotationDegrees(polerot));
        ...
        for (int i = 1; i < 5; ++i) {
            ...
            if (stack != null) {
                ...
                if (manaPercent < 100.0F) {
                    ...
                    if (tile.clientTick[i] > 12) {
                        ...
                        if (Objects.requireNonNull(render.charger.getLevel()).isClientSide) {
                            Level level = render.charger.getLevel();
                ...
                matrixStack.mulPose(Axis.YP.rotationDegrees(8.0F));
                matrixStack.mulPose(Axis.YP.rotationDegrees(rot));
