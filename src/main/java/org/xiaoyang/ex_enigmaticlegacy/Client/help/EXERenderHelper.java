...
public final class EXERenderHelper extends RenderType {
    ...
    private EXERenderHelper(String name, VertexFormat format, VertexFormat.Mode mode,
    ...
    private static final RenderStateShard.ShaderStateShard BLADE_SHADER =
            new RenderStateShard.ShaderStateShard(EXECoreShaders::getBladeShader);
    private static final RenderStateShard.ShaderStateShard SLASH_SHADER =
            new RenderStateShard.ShaderStateShard(EXECoreShaders::getSlashShader);

    public static final RenderType BOLT = create(
            "bolt",
            ...
            CompositeState.builder()
                    .setShaderState(new RenderStateShard.ShaderStateShard(() -> EXECoreShaders.boltShader))
    ...
    static {
        CompositeState state = CompositeState.builder()
                ...
                .setShaderState(new ShaderStateShard(EXECoreShaders::rainbowManaWater))
                .setTransparencyState(TRANSLUCENT_TRANSPARENCY)
        ...
        state = CompositeState.builder()
                .setTextureState(BLOCK_SHEET_MIPPED)
                .setShaderState(new ShaderStateShard(EXECoreShaders::polychromeCollapsePrismOverlay))
                .setTransparencyState(TRANSLUCENT_TRANSPARENCY)
                .setOutputState(ITEM_ENTITY_TARGET)
                .setLightmapState(LIGHTMAP)
                .createCompositeState(false);
        ...
        state = CompositeState.builder()
                .setShaderState(new ShaderStateShard(EXECoreShaders::cosmicBackground))
        ...
        state = CompositeState.builder()
                .setTextureState(BLOCK_SHEET_MIPPED)
                .setShaderState(new ShaderStateShard(EXECoreShaders::evilWater))
                .setTransparencyState(TRANSLUCENT_TRANSPARENCY)
                .setOutputState(ITEM_ENTITY_TARGET)
                .setLightmapState(LIGHTMAP)
                .createCompositeState(false);
        ...
        state = CompositeState.builder()
                .setShaderState(new ShaderStateShard(EXECoreShaders::getStarrySkyShader))
                .setTransparencyState(TRANSLUCENT_TRANSPARENCY)
                .setWriteMaskState(COLOR_WRITE)
                .setOutputState(ITEM_ENTITY_TARGET)
                .setLightmapState(LIGHTMAP)
        ...
        state = CompositeState.builder()
                .setShaderState(new ShaderStateShard(EXECoreShaders::getBlackHoleShader))
        ...
        state = CompositeState.builder()
                .setShaderState(new ShaderStateShard(EXECoreShaders::getAndromedaShader))
        ...
        state = CompositeState.builder()
                .setShaderState(new ShaderStateShard(EXECoreShaders::getStarLineShader))
                .setTextureState(NO_TEXTURE)
                .setTransparencyState(TRANSLUCENT_TRANSPARENCY)
                .setWriteMaskState(COLOR_WRITE)
                .setDepthTestState(LEQUAL_DEPTH_TEST)
