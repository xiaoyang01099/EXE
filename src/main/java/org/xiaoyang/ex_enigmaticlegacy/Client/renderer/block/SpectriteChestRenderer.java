...
import org.xiaoyang.ex_enigmaticlegacy.Block.SpectriteChest;
...
public class SpectriteChestRenderer implements BlockEntityRenderer<SpectriteChestTile> {
    ...
    public void render(SpectriteChestTile blockEntity, float partialTick, PoseStack poseStack,
        ...
        VertexConsumer vertexConsumer = bufferSource.getBuffer(
                RenderType.entityCutout(AnimatedChestTexture.DYNAMIC_LOCATION));

        this.renderParts(poseStack, vertexConsumer,
    ...
    private void renderParts(PoseStack poseStack, VertexConsumer consumer,
                             ModelPart lid, ModelPart lock, ModelPart bottom,
                             float lidAngle, int light, int overlay) {
