...
import org.xiaoyang.ex_enigmaticlegacy.Client.renderer.layer.ColourfulWitherArmorLayer;
	...
	public void render(Xingyun2825Entity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
		...
		if (pEntity.deathTick-650 > 0) {
			...
			for(int $$18 = 0; (float)$$18 < ($$14 + $$14 * $$14) / 2.0F * 60.0F; ++$$18) {
				pMatrixStack.mulPose(Axis.XP.rotationDegrees($$16.nextFloat() * 360.0F));
				pMatrixStack.mulPose(Axis.YP.rotationDegrees($$16.nextFloat() * 360.0F));
				pMatrixStack.mulPose(Axis.ZP.rotationDegrees($$16.nextFloat() * 360.0F));
				pMatrixStack.mulPose(Axis.XP.rotationDegrees($$16.nextFloat() * 360.0F));
				pMatrixStack.mulPose(Axis.YP.rotationDegrees($$16.nextFloat() * 360.0F));
				pMatrixStack.mulPose(Axis.ZP.rotationDegrees($$16.nextFloat() * 360.0F + $$14 * 90.0F));
