...
import org.xiaoyang.ex_enigmaticlegacy.Client.model.RainbowTableModel;
...
public class RainbowTableRenderer implements BlockEntityRenderer<RainbowTableTile> {
    ...
    static {
        for (int i = 0; i < 10; i++) {
            TEXTURES[i] = new ResourceLocation(Exe.MODID,
                    "textures/item/entity/rainbow_table/" + i + ".png");
        }
    }
