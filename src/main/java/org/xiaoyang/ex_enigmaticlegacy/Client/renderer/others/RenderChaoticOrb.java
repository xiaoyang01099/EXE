...
import org.xiaoyang.ex_enigmaticlegacy.Client.particle.fx.ParticleEngine;
...
public class RenderChaoticOrb extends EntityRenderer<EntityChaoticOrb> {
    ...
    private void renderOrbSphere(EntityChaoticOrb entity, PoseStack poseStack, float partialTicks) {
        ...
        for (int i = 0; i < 12; ++i) {
            ...
            poseStack.mulPose(Axis.XP.rotationDegrees(random.nextFloat() * 360.0F));
            poseStack.mulPose(Axis.YP.rotationDegrees(random.nextFloat() * 360.0F));
            poseStack.mulPose(Axis.ZP.rotationDegrees(random.nextFloat() * 360.0F + f1 * 360.0F));
    ...
    private void renderOrbCore(EntityChaoticOrb entity, PoseStack poseStack, float partialTicks) {
        ...
        poseStack.mulPose(Axis.YP.rotationDegrees(180.0F - this.entityRenderDispatcher.camera.getYRot()));
