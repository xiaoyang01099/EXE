...
import org.xiaoyang.ex_enigmaticlegacy.Container.slot.MagicTableRecipeInput;
...
public class MagicTableRecipe implements Recipe<MagicTableRecipeInput> {
    ...
    @Override
    public @NotNull ItemStack assemble(@NotNull MagicTableRecipeInput container,RegistryAccess registryAccess) {
        return output.copy();
    }
