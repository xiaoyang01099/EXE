...
public class RainbowTableRecipe implements Recipe<Container> {
    ...
    public static final ResourceLocation TYPE_ID = new ResourceLocation(Exe.MODID, "rainbow_table");
    ...
    public static class Serializer implements RecipeSerializer<RainbowTableRecipe> {
        ...
        @Nullable
        @Override
        public RainbowTableRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
            NonNullList<Ingredient> inputs = NonNullList.withSize(4, Ingredient.EMPTY);
            NonNullList<Integer> counts = NonNullList.withSize(4, 1);
