...
import org.xiaoyang.ex_enigmaticlegacy.api.exboapi.IPolychromeRecipe;
...
public class PolychromeRecipe implements IPolychromeRecipe {
    ...
    public static final ResourceLocation TYPE_ID = new ResourceLocation(Exe.MODID, "polychrome");
    ...
    public static class Serializer extends NoOpRecipeSerializer<PolychromeRecipe> {
        public Serializer(Function<ResourceLocation, PolychromeRecipe> constructor) {
            super(constructor);
        }
