...
public class CelestialTransmuteRecipe implements Recipe<Container> {
    public static final ResourceLocation TYPE_ID = new ResourceLocation(Exe.MODID, "celestial_transmute");
    ...
    public boolean matches(Container pContainer, Level pLevel) {
        ...
        if (pContainer instanceof CelestialHTTile tile) {
    ...
    public static class Serializer implements RecipeSerializer<CelestialTransmuteRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(Exe.MODID, "celestial_transmute");
