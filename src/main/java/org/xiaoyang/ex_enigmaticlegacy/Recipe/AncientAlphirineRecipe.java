...
public class AncientAlphirineRecipe implements Recipe<Container> {
    ...
    public static final ResourceLocation TYPE_ID = new ResourceLocation(Exe.MODID, "ancient_alphirine");
    ...
    public static class Serializer implements RecipeSerializer<AncientAlphirineRecipe> {
        private static final ResourceLocation NAME = new ResourceLocation(Exe.MODID, "ancient_alphirine");
