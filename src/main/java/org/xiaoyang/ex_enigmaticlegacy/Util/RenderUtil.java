...
public class RenderUtil {
    ...
    public static void renderBeam(BufferBuilder buf, Matrix4f matrix, double x1, double y1, double z1, double x2, double y2, double z2, float r1, float g1, float b1, float a1, float r2, float g2, float b2, float a2, double width) {
    ...
    public static void renderBeam(BufferBuilder buf, Matrix4f matrix, double x1, double y1, double z1, double x2, double y2, double z2, float r1, float g1, float b1, float a1, float r2, float g2, float b2, float a2, double width, double angle) {
    ...
    public static void renderBeam(BufferBuilder buf, Matrix4f matrix, double x1, double y1, double z1, double x2, double y2, double z2, float r1, float g1, float b1, float a1, float r2, float g2, float b2, float a2, double width1, double width2, double angle) {
        float rads = (float) Math.toRadians(angle);
        double ac = Mth.cos(rads);
        double as = Mth.sin(rads);
    ...
    public static void renderSlash(BufferBuilder buf, Matrix4f matrix, double x0, double y0, double z0, float r, float g, float b, float a, float radius, float width, float angleRange) {
    ...
    private static void addVertex(BufferBuilder buf, Matrix4f matrix, double x, double y, double z, float u, float v, float r, float g, float b, float a) {
