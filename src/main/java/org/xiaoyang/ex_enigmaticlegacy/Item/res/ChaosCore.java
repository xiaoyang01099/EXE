...
public class ChaosCore extends Item {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.chaos_core.lore1")
                    .withStyle(ChatFormatting.DARK_PURPLE));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.chaos_core.lore2")
                    .withStyle(ChatFormatting.DARK_PURPLE));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.chaos_core.lore3")
                    .withStyle(ChatFormatting.DARK_PURPLE));
            tooltip.add(Component.translatable(""));

            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.chaos_core.tooltip")
                    .withStyle(ChatFormatting.DARK_PURPLE));

            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.chaos_core.lore4")
                    .withStyle(ChatFormatting.RED));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.chaos_core.lore5")
                    .withStyle(ChatFormatting.RED));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.chaos_core.lore6")
                    .withStyle(ChatFormatting.RED));
            tooltip.add(Component.translatable(""));

            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.chaos_core.lore7")
