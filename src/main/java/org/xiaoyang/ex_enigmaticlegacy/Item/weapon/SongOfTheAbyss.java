...
public class SongOfTheAbyss extends SwordItem implements Vanishable {
    ...
    public SongOfTheAbyss() {
        super(EXEAPI.MIRACLE_ITEM_TIER, 200, -2.2F, new Properties().fireResistant());
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide && player.getCooldowns().getCooldownPercent(this, 0) == 0) {
            ...
            level.playSound(null, player.blockPosition(),
                    ModSounds.SONG_OF_THE_ABYSS.get(), SoundSource.PLAYERS, 1.0F, 0.8F);
    ...
    private void spawnSlashEntity(Level level, Player player) {
        ...
        double x2 = player.getX() + lookVec.x * 8.0;
        double y2 = player.getY() + player.getEyeHeight() + lookVec.y * 8.0;
        double z2 = player.getZ() + lookVec.z * 8.0;
        ...
        AABB damageBox = new AABB(lx - 3.0, ly - 3.0, lz - 3.0,
    ...
    private void spawnCriticalSlash(Level level, Player player, LivingEntity target) {
        ...
        level.playSound(null, target.blockPosition(),
                ModSounds.SONG_OF_THE_ABYSS.get(), SoundSource.PLAYERS, 3.0F, 1.0F);
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("tooltip.song_of_the_abyss.line1"));
        tooltip.add(Component.translatable("tooltip.song_of_the_abyss.line2"));
        tooltip.add(Component.translatable("tooltip.song_of_the_abyss.line3"));
        tooltip.add(Component.translatable("tooltip.song_of_the_abyss.line4"));
        tooltip.add(Component.translatable("tooltip.song_of_the_abyss.line5"));
        tooltip.add(Component.translatable("tooltip.song_of_the_abyss.line6"));
        tooltip.add(Component.translatable("tooltip.song_of_the_abyss.line7"));
    }
}