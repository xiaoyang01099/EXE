...
//    public static final RegistryObject<Item> BLADE_FALLEN_STAR = REGISTRY.register("blade_fallen_star", BladeFallenStar::new);
    ...
    public static final RegistryObject<Item> SPACE_BLADE = REGISTRY.register("space_blade", () -> new SpaceBlade(new Item.Properties()));
    public static final RegistryObject<Item> NATURAL_THOUSAND_BLADES = REGISTRY.register("natural_thousand_blades", () -> new NaturalThousandBlades(new Item.Properties()));
