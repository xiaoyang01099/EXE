...
import org.xiaoyang.ex_enigmaticlegacy.Network.inputPacket.EXPacketIndex;
import org.xiaoyang.ex_enigmaticlegacy.Recipe.ExtremeDeconRecipe;
import org.xiaoyang.ex_enigmaticlegacy.Recipe.Manager.ExtremeCraftingDeconstructionManager;
...
public class ExtremeDisassemblyMenu extends AbstractContainerMenu {
    ...
    public ExtremeDisassemblyMenu(int windowId, Inventory playerInventory, ContainerLevelAccess access) {
        super(ModMenus.EXTREME_CRAFTING_DISASSEMBLY_MENU.get(), windowId);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(this.access, playerIn, ModBlocks.EXTREME_CRAFTING_DISASSEMBLY_TABLE.get());
    }
