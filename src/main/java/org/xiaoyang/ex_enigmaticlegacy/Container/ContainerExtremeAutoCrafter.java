...
import org.xiaoyang.ex_enigmaticlegacy.Container.slot.AutoCraftSlot;
import org.xiaoyang.ex_enigmaticlegacy.Init.ModMenus;
import org.xiaoyang.ex_enigmaticlegacy.Network.NetworkHandler;
import org.xiaoyang.ex_enigmaticlegacy.Network.inputPacket.AutoCrafterPacket;
import org.xiaoyang.ex_enigmaticlegacy.Network.inputPacket.AutoCrafterRecipePacket;
...
public final class ContainerExtremeAutoCrafter extends AbstractContainerMenu {
    ...
    public ContainerExtremeAutoCrafter(int containerId, Inventory inventory, Container tileAutoCraft) {
        super(ModMenus.EXTREME_AUTO_CRAFTER_MENU.get(), containerId);
    ...
    public class OutputSlot extends Slot {
        public OutputSlot(Container inv, int idx, int x, int y) {
            super(inv, idx, x, y);
        }
