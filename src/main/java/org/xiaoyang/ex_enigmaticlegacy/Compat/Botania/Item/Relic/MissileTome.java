...
import org.xiaoyang.ex_enigmaticlegacy.Entity.others.EntityRageousMissile;
...
public class MissileTome extends Item implements INoEMCItem {
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nullable Level world, @Nonnull List<Component> tooltip, @Nonnull TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.missile_tome.description1"));
            tooltip.add(Component.translatable("item.missile_tome.description2"));
            tooltip.add(Component.translatable("item.missile_tome.description3"));
            tooltip.add(Component.translatable(""));
            tooltip.add(Component.translatable("item.missile_tome.damage_info",
                    (int)DAMAGE_MIN, (int)DAMAGE_MAX));
            tooltip.add(Component.translatable(""));
            tooltip.add(Component.translatable("item.missile_tome.mana_cost", MANA_COST));
        } else {
