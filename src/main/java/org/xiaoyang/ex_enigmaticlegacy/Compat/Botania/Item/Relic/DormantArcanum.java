...
public class DormantArcanum extends Item implements ICurioItem, INoEMCItem {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dormant_arcanum.lore1")
                    .withStyle(ChatFormatting.GRAY));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dormant_arcanum.lore2")
                    .withStyle(ChatFormatting.DARK_PURPLE));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dormant_arcanum.lore3")
        ...
        if (itemStack.hasTag()) {
            ...
            tooltip.add(Component.translatable(""));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dormant_arcanum.time")
                    .append(Component.translatable(": " + String.format("%.1f", seconds) + "s"))
    ...
    private void awakeParcanum(Player player, ItemStack stack, SlotContext slotContext) {
        ...
        player.sendSystemMessage(Component.translatable("item.ex_enigmaticlegacy.dormant_arcanum.awakened")
    ...
    public void onEquip(SlotContext slotContext, ItemStack prevStack, ItemStack stack) {
        if (slotContext.entity() instanceof Player player) {
            ...
            int lifetime = ItemNBTHelper.getInt(stack, "ILifetime", 0);
            player.sendSystemMessage(Component.translatable("item.ex_enigmaticlegacy.dormant_arcanum.equipped")
                    .append(Component.translatable(" (" + (lifetime / 10) + "s remaining)"))
                    .withStyle(ChatFormatting.GRAY));
        }
    }
    ...
    public void onUnequip(SlotContext slotContext, ItemStack newStack, ItemStack stack) {
        if (slotContext.entity() instanceof Player player) {
            player.sendSystemMessage(Component.translatable("item.ex_enigmaticlegacy.dormant_arcanum.unequipped")
                    .withStyle(ChatFormatting.GRAY));
        }
    }
            ...
            for (LivingEntity entity : nearbyEntities) {
                if (entity instanceof Player) {
                    ...
                    targetPlayer.sendSystemMessage(
                            Component.translatable("item.ex_enigmaticlegacy.dormant_arcanum.void_banishment")
                ...
                entity.hurt(ModDamageSources.trueDamage(entity.level()), voidDamage);
            ...
            CuriosApi.getCuriosHelper().findEquippedCurio(ModItems.DORMANT_ARCANUM.get(), player)
                    .ifPresent(result -> {
                        ...
                        player.sendSystemMessage(
                                Component.translatable("item.ex_enigmaticlegacy.dormant_arcanum.death_trigger")
