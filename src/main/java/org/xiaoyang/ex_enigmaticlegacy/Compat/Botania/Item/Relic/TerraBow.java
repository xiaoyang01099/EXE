...
public class TerraBow extends LivingwoodBowItem implements INoEMCItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_bow.tooltip.line1"));
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_bow.tooltip.line2"));

        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_bow.tooltip.multishot")
                .withStyle(ChatFormatting.YELLOW));
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_bow.tooltip.pattern",
                ARROW_ROWS + "x" + ARROW_COLS).withStyle(ChatFormatting.GRAY));

        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_bow.tooltip.instant_kill")
                .withStyle(ChatFormatting.RED));
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_bow.tooltip.chance",
        ...
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_bow.tooltip.mana_cost", manaCost)
                .withStyle(ChatFormatting.AQUA));

        if (hasInfinity) {
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_bow.tooltip.infinity_bonus")
                    .withStyle(ChatFormatting.GREEN));
        }

        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_bow.tooltip.base_damage",
        ...
        if (!player.getAbilities().instabuild && !flag) {
            if (!level.isClientSide) {
                player.displayClientMessage(
                        Component.translatable("item.ex_enigmaticlegacy.terra_bow.insufficient_mana")
    ...
    @Override
    public void releaseUsing(@Nonnull ItemStack stack, @Nonnull Level level, @NotNull LivingEntity entityLiving, int timeLeft) {
        ...
        if (!level.isClientSide) {
            ...
            if (hasInstantKill) {
                player.displayClientMessage(
                        Component.translatable("item.ex_enigmaticlegacy.terra_bow.instant_kill_triggered")
