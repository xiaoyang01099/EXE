...
public class DarkSunRing extends Item implements ICurioItem, INoEMCItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore1")
                    .withStyle(ChatFormatting.GOLD));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore2_1")
                    .append(" " + 100)
                    .append(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore2_2"))
                    .withStyle(ChatFormatting.GOLD));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore3")
                    .withStyle(ChatFormatting.GOLD));
            tooltip.add(Component.translatable(""));

            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore4_1")
                    .append(" " + (int)(0.2F * 100.0F))
                    .append(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore4_2"))
                    .withStyle(ChatFormatting.GOLD));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore5")
                    .withStyle(ChatFormatting.GOLD));
            tooltip.add(Component.translatable(""));

            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore6")
                    .withStyle(ChatFormatting.GOLD));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore7")
                    .withStyle(ChatFormatting.GOLD));
            tooltip.add(Component.translatable(""));

            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore8")
                    .withStyle(ChatFormatting.GOLD));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.dark_sun_ring.lore9")
                    .withStyle(ChatFormatting.GOLD));
            tooltip.add(Component.translatable(""));
        } else {
