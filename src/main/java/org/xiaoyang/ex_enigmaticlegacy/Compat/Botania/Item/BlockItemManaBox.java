...
public class BlockItemManaBox extends BlockItem implements ManaItem {
    ...
    public BlockItemManaBox() {
        super(ModBlocks.MANA_BOX.get(), BotaniaItems.defaultBuilder().stacksTo(1).rarity(Rarity.EPIC));
    }

    @Override
    public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag nbt) {
        return new ICapabilityProvider() {
            private final LazyOptional<ManaItem> manaItem = LazyOptional.of(() -> new ManaItem() {
                @Override
                public int getMana() {
