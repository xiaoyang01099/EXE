...
import org.xiaoyang.ex_enigmaticlegacy.Entity.others.EntityChaoticOrb;
...
public class ChaosTome extends Item implements INoEMCItem, ICursed {
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("tooltip.chaos_tome.advanced1")
                    .withStyle(ChatFormatting.DARK_PURPLE));
            tooltip.add(Component.translatable("tooltip.chaos_tome.advanced2")
                    .withStyle(ChatFormatting.DARK_PURPLE));
            tooltip.add(Component.translatable("tooltip.chaos_tome.damage",
                    1, (int)CHAOS_TOME_DAMAGE_CAP).withStyle(ChatFormatting.RED));
            tooltip.add(Component.translatable("tooltip.chaos_tome.cost", EXPERIENCE_COST_PER_ORB)
                    .withStyle(ChatFormatting.GREEN));
        } else {
            tooltip.add(Component.translatable("tooltip.chaos_tome.desc")
                    .withStyle(ChatFormatting.GRAY));
            tooltip.add(Component.translatable("tooltip.chaos_tome.usage")
                    .withStyle(ChatFormatting.GRAY));
        }
    }
