...
import org.xiaoyang.ex_enigmaticlegacy.Entity.others.EntityLunarFlare;
...
public class LunarFlares extends Item implements INoEMCItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.lunar_flares.desc1"));
            tooltip.add(Component.translatable(""));
            tooltip.add(Component.translatable("item.lunar_flares.desc2"));
            tooltip.add(Component.translatable("item.lunar_flares.damage_impact", (int)DAMAGE_IMPACT));
            tooltip.add(Component.translatable("item.lunar_flares.desc3"));
            tooltip.add(Component.translatable(""));
            tooltip.add(Component.translatable("item.lunar_flares.damage_direct", (int)DAMAGE_DIRECT));
        } else {
