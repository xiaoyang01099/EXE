...
public class AlphirinePortalRenderer extends EntityRenderer<AlphirinePortal> {
    ...
    @Override
    public void render(AlphirinePortal entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        ...
        poseStack.mulPose(Axis.ZP.rotationDegrees((float)worldTime * 2.0F));
