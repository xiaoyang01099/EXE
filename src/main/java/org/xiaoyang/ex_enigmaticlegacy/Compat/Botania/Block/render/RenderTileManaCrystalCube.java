...
import org.xiaoyang.ex_enigmaticlegacy.Client.model.ModelCrystalCube;
import org.xiaoyang.ex_enigmaticlegacy.Compat.Botania.Block.tile.ManaCrystalCubeBlockTile;
...
public class RenderTileManaCrystalCube implements BlockEntityRenderer<ManaCrystalCubeBlockTile> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Exe.MODID, "textures/item/entity/crystal_cube.png");
    ...
    public void render(ManaCrystalCubeBlockTile blockEntity, float partialTicks, PoseStack poseStack,
        ...
        if (this.entity == null) {
            this.entity = new ItemEntity(
                    ...
                    new ItemStack(BotaniaItems.twigWand)
            );
        }
        ...
        if (mana[1] > 0 && blockEntity.getLevel() != null) {
            ...
            poseStack.pushPose();
            poseStack.mulPose(Axis.YP.rotationDegrees(90F * faceIndex));
