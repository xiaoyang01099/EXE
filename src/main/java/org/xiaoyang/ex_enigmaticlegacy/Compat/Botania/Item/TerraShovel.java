...
public class TerraShovel extends ManasteelShovelItem implements SequentialBreaker {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_shovel.tooltip.line1"));
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_shovel.tooltip.line2"));
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_shovel.tooltip.line3"));
        ...
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_shovel.tooltip.mode", modeText));
        ...
        Component statusText = Component.translatable(statusKey).withStyle(statusColor);
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.terra_shovel.tooltip.status", statusText));
    }
    ...
    public void breakOtherBlock(Player player, ItemStack stack, BlockPos pos, BlockPos originPos, Direction side) {
        ...
        if (!blockstate.canBeReplaced() && !blockstate.is(BlockTags.MINEABLE_WITH_SHOVEL)
    ...
    private void cycleFunctionMode(ItemStack stack, Player player) {
        ...
        if (!player.level.isClientSide) {
            Component message = Component.translatable("item.ex_enigmaticlegacy.terra_shovel.mode_change")
                    .withStyle(ChatFormatting.GREEN)
                    .append(Component.translatable(MODE_LANG_KEYS[nextMode])
                            .withStyle(ChatFormatting.YELLOW));
            player.displayClientMessage(message, false);

            player.level.playSound(null, player.getX(), player.getY(), player.getZ(),
                    BotaniaSounds.terraPickMode, SoundSource.PLAYERS, 0.3F, 1.0F + nextMode * 0.2F);
        }
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player player, @Nonnull InteractionHand hand) {
        ...
        if (!world.isClientSide) {
            world.playSound(null, player.getX(), player.getY(), player.getZ(), BotaniaSounds.terraPickMode,
            ...
            Component message = Component.translatable("item.ex_enigmaticlegacy.terra_shovel.toggle")
                    .withStyle(ChatFormatting.GREEN)
    ...
    public InteractionResult useOn(UseOnContext ctx) {
        ...
        int range = 2 + (!RingOfThorItem.getThorRing(player).isEmpty() ? 1 : 0);
        if (StoneOfTemperanceItem.hasTemperanceActive(player))
            range = 1;
        if (player.isShiftKeyDown() || !isEnabled(stack))
            range = 0;
