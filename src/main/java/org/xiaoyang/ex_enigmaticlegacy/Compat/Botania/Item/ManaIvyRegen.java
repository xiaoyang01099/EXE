...
public class ManaIvyRegen extends Item implements CustomCreativeTabContents {
	...
	public @Nullable ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag nbt) {
		return new ICapabilityProvider() {
			private final LazyOptional<ManaItem> manaHandler = LazyOptional.of(() -> new IManaItem(stack));
