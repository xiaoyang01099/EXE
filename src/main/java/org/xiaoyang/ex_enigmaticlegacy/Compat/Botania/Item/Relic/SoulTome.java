...
import org.xiaoyang.ex_enigmaticlegacy.Entity.others.EntitySoulEnergy;
    ...
    public void onUseTick(Level level, LivingEntity livingEntity, ItemStack stack, int remainingUseDuration) {
        ...
        if (count > 20 && count % 4 == 0) {
            ...
            if (randomEntity != null && !level.isClientSide) {
                ...
                randomEntity.hurt(new ModDamageSources.DamageSourceSoulDrain(level, player), soulDamage);
