...
public class Apotheosis extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.apotheosis.desc1").withStyle(ChatFormatting.GOLD));
            tooltip.add(Component.translatable(""));
            tooltip.add(Component.translatable("item.apotheosis.desc2").withStyle(ChatFormatting.GRAY));
            tooltip.add(Component.translatable("item.apotheosis.desc3").withStyle(ChatFormatting.GRAY));
            tooltip.add(Component.translatable(""));
            tooltip.add(Component.translatable("item.apotheosis.damage_direct").withStyle(ChatFormatting.RED));
            tooltip.add(Component.translatable("item.apotheosis.damage_impact").withStyle(ChatFormatting.RED));
            tooltip.add(Component.translatable("item.apotheosis.desc4").withStyle(ChatFormatting.YELLOW));
        } else {
