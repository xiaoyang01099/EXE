...
import org.xiaoyang.ex_enigmaticlegacy.Network.inputMessage.PlayerMotionUpdateMessage;
import org.xiaoyang.ex_enigmaticlegacy.Network.inputMessage.TelekinesisAttackMessage;
import org.xiaoyang.ex_enigmaticlegacy.Network.inputMessage.TelekinesisParticleMessage;
import org.xiaoyang.ex_enigmaticlegacy.Network.inputMessage.TelekinesisUseMessage;
...
public class TelekinesisTome extends Item implements INoEMCItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.ItemTelekinesisTome1.lore"));
            tooltip.add(Component.translatable("item.ItemTelekinesisTome2.lore"));
            tooltip.add(Component.translatable("item.ItemTelekinesisTome3.lore"));
            tooltip.add(Component.translatable("item.FREmpty.lore"));
            tooltip.add(Component.translatable("item.ItemTelekinesisTome4.lore"));
            tooltip.add(Component.translatable("item.ItemTelekinesisTome5.lore"));
            tooltip.add(Component.translatable("item.ItemTelekinesisTome6.lore"));
            tooltip.add(Component.translatable("item.FREmpty.lore"));
            tooltip.add(Component.translatable("item.ItemTelekinesisTome7.lore"));
            tooltip.add(Component.translatable("item.ItemTelekinesisTome8.lore"));
            tooltip.add(Component.translatable("item.ItemTelekinesisTome9.lore"));
            tooltip.add(Component.translatable("item.FREmpty.lore"));
            tooltip.add(Component.translatable("item.ItemTelekinesisTome10.lore"));
            tooltip.add(Component.translatable("item.FREmpty.lore"));
            tooltip.add(Component.translatable("Damage: " + (int)TELEKINESIS_TOME_DAMAGE_MIN + "~" + (int)TELEKINESIS_TOME_DAMAGE_MAX));
        } else {
    ...
    public static void lightningAttack(Player player, LivingEntity target, ItemStack stack, Level world) {
        ...
        if (!world.isClientSide && !RelicsEventHandler.isOnCoodown(player)) {
            ...
            if (player.distanceTo(target) <= 16.0F) {
                ...
                target.hurt(ModDamageSources.lightning(target.level(), player),
