...
public class NebulousCore extends Item implements ICurioItem, INoEMCItem {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.ex_enigmaticlegacy.arcanum.effect")
                .withStyle(ChatFormatting.BLUE));
        tooltip.add(Component.translatable(""));

        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.arcanum.lore1")
                    .withStyle(ChatFormatting.DARK_PURPLE));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.arcanum.lore2")
                    .withStyle(ChatFormatting.DARK_PURPLE));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.arcanum.lore3")
                    .withStyle(ChatFormatting.DARK_PURPLE));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.arcanum.lore4")
                    .withStyle(ChatFormatting.DARK_PURPLE));
            tooltip.add(Component.translatable(""));

            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.arcanum.lore6")
                    .withStyle(ChatFormatting.RED));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.arcanum.lore7")
                    .withStyle(ChatFormatting.RED));
            tooltip.add(Component.translatable("item.ex_enigmaticlegacy.arcanum.lore8")
                    .withStyle(ChatFormatting.RED));
            tooltip.add(Component.translatable(""));

            tooltip.add(Component.translatable("Teleport Chance: " + String.format("%.4f%%", TELEPORT_CHANCE * 100))
                    .withStyle(ChatFormatting.AQUA));
            tooltip.add(Component.translatable("Dormant Chance: " + String.format("%.5f%%", DORMANT_CHANCE * 100))
    ...
    private void transformToDormantArcanum(Player player, ItemStack stack, SlotContext slotContext) {
        ...
        player.sendSystemMessage(Component.translatable("item.ex_enigmaticlegacy.arcanum.dormant")
                .append(Component.translatable(" (" + (lifetime / 20) + "s)"))
                .withStyle(ChatFormatting.DARK_PURPLE));
    }
    ...
    public void onEquip(SlotContext slotContext, ItemStack prevStack, ItemStack stack) {
        if (slotContext.entity() instanceof Player player) {
            ...
            player.sendSystemMessage(Component.translatable("item.ex_enigmaticlegacy.arcanum.equipped")
                    .withStyle(ChatFormatting.BLUE));
        }
    }
    ...
    public void onUnequip(SlotContext slotContext, ItemStack newStack, ItemStack stack) {
        if (slotContext.entity() instanceof Player player) {
            player.sendSystemMessage(Component.translatable("item.ex_enigmaticlegacy.arcanum.unequipped")
