...
public class OrechidEndiumTile extends OrechidBlockEntity {
    ...
    public static class FunctionalWandHud extends BindableSpecialFlowerBlockEntity.BindableFlowerWandHud<OrechidEndiumTile> {
    ...
    private BlockState getOre() {
        ...
        for (Block block : ForgeRegistries.BLOCKS) {
            if (block.defaultBlockState().is(BlockTags.COAL_ORES) ||
