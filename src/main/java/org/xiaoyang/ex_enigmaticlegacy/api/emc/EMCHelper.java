package org.xiaoyang.ex_enigmaticlegacy.api.emc;
...
public class EMCHelper {
    ...
    public static class NoEMCMapper implements IEMCMapper<NormalizedSimpleStack, Long> {
        ...
        @Override
        public void addMappings(IMappingCollector<NormalizedSimpleStack, Long> collector, CommentedFileConfig commentedFileConfig, ReloadableServerResources reloadableServerResources, RegistryAccess registryAccess, ResourceManager resourceManager) {
