...
public class CircleShockwaveShader {
    ...
    public static AbstractUniform noiseParams;
    public static AbstractUniform circleNoiseSpriteUV;
    ...
    public static ShaderInstance reloadShaders(ResourceProvider manager) throws IOException {
        return new ShaderInstance(
                manager,
                new ResourceLocation(Exe.MODID, "magic_circle/circle_shockwave"),
