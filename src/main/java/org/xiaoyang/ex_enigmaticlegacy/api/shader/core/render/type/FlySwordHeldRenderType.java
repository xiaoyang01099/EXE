...
public class FlySwordHeldRenderType extends RenderType {
    public static final ShaderStateShard SHADER_STATE =
            new ShaderStateShard(FlySwordHeldShader::getShader);

    public static final MultiTextureStateShard HELD_TEXTURES =
            MultiTextureStateShard.builder()
                    .add(EXETextureAtlas.EXE_TOOL_ATLAS_LOCATION, false, false)
                    .build();
