...
public class GoldenSpiralRenderType extends RenderType {
    public static final ShaderStateShard GOLDEN_SPIRAL_SHADER_STATE =
            new ShaderStateShard(GoldenSpiralShader::getShader); // 金色螺旋 shader 状态。
    public static final TextureStateShard EXE_ATLAS_TEXTURE =
            new TextureStateShard(EXETextureAtlas.EXE_TOOL_ATLAS_LOCATION, false, false);
    public static final TransparencyStateShard STANDARD_ALPHA_TRANSPARENCY =
