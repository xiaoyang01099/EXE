...
import org.xiaoyang.ex_enigmaticlegacy.api.shader.core.render.type.ShockwaveRenderType;
...
public class ShockwaveQueue {
    ...
    public TextureAtlasSprite shockwaveSprite;
    ...
    public void render(MultiBufferSource.BufferSource fboBuffer, Camera camera, float partialTick, Matrix4f viewMatrix) {
        ...
        ShockwaveShader.setSamplers(EXETextureAtlas.EXE_TOOL_ATLAS.getId());
    ...
    public TextureAtlasSprite getShockwaveSprite() {
        if (shockwaveSprite == null) shockwaveSprite = EXETextureAtlas.getTextureLocation(EXETextureAtlas.trail_2);
