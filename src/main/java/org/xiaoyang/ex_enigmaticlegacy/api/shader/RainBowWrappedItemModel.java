...
public abstract class RainBowWrappedItemModel implements BakedModel {
    ...
    private static final SimpleModelState IDENTITY_STATE =
    ...
    public RainBowWrappedItemModel(BakedModel wrapped) {
        this.overrideList = new ItemOverrides() {
            ...
            public BakedModel resolve(
                    final @NotNull BakedModel originalModel,
                    final @NotNull ItemStack stack,
                    final @Nullable ClientLevel world,
                    final @Nullable LivingEntity entity,
                    final int seed) {

                RainBowWrappedItemModel.this.entity = entity;
                RainBowWrappedItemModel.this.world = world != null ? world
                        : (entity != null ? (ClientLevel) entity.level() : null);

                if (RainBowWrappedItemModel.this.isCosmic()) {
                    return RainBowWrappedItemModel.this.wrapped
                            .getOverrides()
        ...
        this.parentState = (PerspectiveModelState) TransformUtils.stateFromItemTransforms(
