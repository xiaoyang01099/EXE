...
import static org.xiaoyang.ex_enigmaticlegacy.api.shader.cosmic.CosmicBeamRenderer.EXERenderTypes.LASER_BEAM_TYPE;
import static org.xiaoyang.ex_enigmaticlegacy.api.shader.cosmic.CosmicBeamRenderer.EXERenderTypes.LASER_CORE_TYPE;
...
public class CosmicBeamRenderer {
    ...
    public static class EXERenderTypes extends RenderStateShard {
        private EXERenderTypes() {
            super("", () -> {}, () -> {});
        }
        ...
        private static TextureStateShard tex(String path) {
            return new TextureStateShard(
                    new ResourceLocation(Exe.MODID, path),
                    false, false
            );
        }

        private static RenderType.CompositeState additiveSpriteState(String texPath) {
            return RenderType.CompositeState.builder()
                    .setShaderState(cosmicShaderState())
                    .setTextureState(tex(texPath))
        ...
        public static final RenderType LASER_BEAM_TYPE = RenderType.create(
                "laser_beam",
                DefaultVertexFormat.POSITION_COLOR_TEX,
                VertexFormat.Mode.QUADS,
                256, false, false,
                additiveSpriteState("textures/particle/laser_beam.png")
        );

        public static final RenderType LASER_ORB_TYPE = RenderType.create(
                "laser_orb",
                DefaultVertexFormat.POSITION_COLOR_TEX,
                VertexFormat.Mode.QUADS,
                256, false, false,
                additiveSpriteState("textures/particle/laser_orb.png")
        );

        public static final RenderType LASER_CORE_TYPE = RenderType.create(
                "laser_core",
                DefaultVertexFormat.POSITION_COLOR_TEX,
                VertexFormat.Mode.QUADS,
                256, false, false,
                additiveSpriteState("textures/particle/laser_core.png")
        );

        public static final RenderType LASER_ORANGE_GLOW_TYPE = RenderType.create(
                "laser_orange_glow",
                DefaultVertexFormat.POSITION_COLOR_TEX,
                VertexFormat.Mode.QUADS,
                256, false, false,
        ...
        public static final RenderType ENERGY_RING_TYPE = RenderType.create(
                "energy_ring",
        ...
        public static final RenderType ELECTRIC_ARC_TYPE = RenderType.create(
                "electric_arc",
                DefaultVertexFormat.POSITION_COLOR,
    ...
    private static void renderChargeRings(PoseStack poseStack, MultiBufferSource.BufferSource bufferSource,
        ...
        VertexConsumer buffer = bufferSource.getBuffer(EXERenderTypes.ENERGY_RING_TYPE);
    ...
    private static void renderEnergyRing(PoseStack poseStack, VertexConsumer buffer,
        ...
        poseStack.mulPose(Axis.YP.rotationDegrees(ring.rotation));
    ...
    private static void renderLaserOrangeGlow(PoseStack poseStack, MultiBufferSource.BufferSource bufferSource,
        ...
        VertexConsumer buffer = bufferSource.getBuffer(EXERenderTypes.LASER_ORANGE_GLOW_TYPE);
    ...
    private static void renderLaserOrb(PoseStack poseStack, MultiBufferSource.BufferSource bufferSource,
        ...
        VertexConsumer buffer = bufferSource.getBuffer(EXERenderTypes.LASER_ORB_TYPE);
    ...
    private static void renderElectricArcs(PoseStack poseStack, MultiBufferSource.BufferSource bufferSource,
        ...
        VertexConsumer buffer = bufferSource.getBuffer(EXERenderTypes.ELECTRIC_ARC_TYPE);
