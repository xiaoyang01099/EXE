...
public class OverthrowChatMessage {
    ...
    private void handleClientSide() {
        ...
        if (player != null) {
            ...
            if (this.type == 0) {
                message = Component.literal(this.overthrower + " ")
                        .append(Component.translatable("message.overthrown1"))
                        .append(Component.literal(" " + this.overthrownPlayer + " "))
                ...
                message = Component.literal("Unknown overthrow message type: " + this.type);
            }
