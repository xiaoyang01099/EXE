...
import org.xiaoyang.ex_enigmaticlegacy.Compat.Botania.Item.SprawlRod;
...
public class EntitySeed extends ThrowableProjectile implements ItemSupplier {
    ...
    protected void onHit(HitResult hitResult) {
        if (hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            if (!seed.isEmpty() && seed.getItem() instanceof GrassSeedsItem) {
                GrassSeedsItem itemSeed = (GrassSeedsItem) seed.getItem();
    ...
    private boolean isTopBlock(BlockPos pos) {
        ...
        return blockState.isAir() || block instanceof BushBlock;
    }
