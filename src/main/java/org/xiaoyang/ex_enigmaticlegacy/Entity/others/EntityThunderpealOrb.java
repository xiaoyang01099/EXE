...
public class EntityThunderpealOrb extends ThrowableProjectile {
    ...
    protected void onHit(HitResult hitResult) {
        ...
        if (hitResult instanceof EntityHitResult entityHitResult) {
            ...
            hitEntity.hurt(
                    new ModDamageSources.DamageSourceTLightning(this.level(), this.getOwner()),
                    DEFAULT_DAMAGE_THUNDERPEAL_DIRECT
            );
        ...
        if (!this.level().isClientSide) {
            ...
            for (Entity e : list) {
                ...
                this.shootLightning(this.level(), this, targetVec.x, targetVec.y, targetVec.z, true);  // FIX
                ...
                for (Entity ex : exlist) {
                    ...
                    this.shootLightning(this.level(), e, targetVecX.x, targetVecX.y, targetVecX.z, false);  // FIX
