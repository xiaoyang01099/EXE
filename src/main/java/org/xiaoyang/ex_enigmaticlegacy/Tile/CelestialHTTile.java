...
import org.xiaoyang.ex_enigmaticlegacy.Container.ChtMenuData;
...
public class CelestialHTTile extends RandomizableContainerBlockEntity implements MenuProvider {
	...
	protected Component getDefaultName() {
		return Component.translatable("celestial_holiness_transmuter");
	}
	...
	public Component getDisplayName() {
		return Component.translatable("Celestial Holiness Transmuter");
	}
