...
public class EvilIngotHandler {
    ...
    public static void onItemPickup(TickEvent.PlayerTickEvent event) {
        if (event.player.getInventory().contains(new ItemStack(EnigmaticItems.EVIL_INGOT))) {
        ...
        public static void onTooltipRender(RenderTooltipEvent.GatherComponents event) {
            ...
            if (stack.getItem() == ModBlocks.EVILBLOCK.get().asItem()) {
                ...
                if (!hasevilIngot) {
                    ...
                    Component obfuscatedText = Component.translatable(obfuscatedName);
                    ...
                    Component coloredText = Component.translatable(coloredName);
