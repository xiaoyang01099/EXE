...
import org.xiaoyang.ex_enigmaticlegacy.Effect.FlyingEffect;
import org.xiaoyang.ex_enigmaticlegacy.Exe;
import org.xiaoyang.ex_enigmaticlegacy.Init.ModArmors;
import org.xiaoyang.ex_enigmaticlegacy.Init.ModEffects;
import org.xiaoyang.ex_enigmaticlegacy.Item.res.StarflowerStone;
        ...
        if (playersWithFlyEffect.contains(key)) {
            if (flying) {
                ...
                if (player.getAbilities().mayfly && !player.isCreative() && !player.isSpectator()) {
                    ...
                    player.displayClientMessage(Component.translatable("info.ex_enigmaticlegacy.flying.stop"), true);
                    if (!player.onGround()) {
