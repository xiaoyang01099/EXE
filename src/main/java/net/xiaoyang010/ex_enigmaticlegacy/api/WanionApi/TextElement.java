...
public class TextElement extends WElement<TextElement>
{
    ...
    public void draw(@Nonnull final WInteraction wInteraction)
    {
        ...
        if (drawShadow) {
            font.drawShadow(poseStack, getText(), getUsableX(), getUsableY(), getColor());
        } else {
            font.draw(poseStack, getText(), getUsableX(), getUsableY(), getColor());
        }
    }
    ...
    public enum TextAnchor
    {
        ...
        MIDDLE(textElement -> textElement.x - (textElement.font.width(textElement.getText()) / 2)),
        RIGHT(textElement -> textElement.x - textElement.font.width(textElement.getText()));
