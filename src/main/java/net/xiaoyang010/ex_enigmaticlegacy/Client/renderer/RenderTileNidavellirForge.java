...
import net.xiaoyang010.ex_enigmaticlegacy.Compat.Botania.Block.TileNidavellirForge;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

public class RenderTileNidavellirForge implements BlockEntityRenderer<TileNidavellirForge> {
    ...
    @Override
    public void render(TileNidavellirForge tile, float partialTicks, PoseStack poseStack, MultiBufferSource buffer,
        ...
        for (int i = 1; i < entityList.size(); i++) {
            ...
            if (!stack.isEmpty()) {
                switch (i) {
                    case 1 -> poseStack.translate(0.15F, 0.0F, 0.0F);
                    case 2 -> poseStack.translate(-0.15F, 0.0F, -0.15F);
                    case 3 -> poseStack.translate(-0.15F, 0.0F, 0.15F);
                }
