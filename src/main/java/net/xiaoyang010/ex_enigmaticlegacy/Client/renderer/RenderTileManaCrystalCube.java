...
import net.xiaoyang010.ex_enigmaticlegacy.Compat.Botania.Block.ManaCrystalCubeBlockEntity;
...
public class RenderTileManaCrystalCube implements BlockEntityRenderer<ManaCrystalCubeBlockEntity> {
    ...
    @Override
    public void render(ManaCrystalCubeBlockEntity blockEntity, float partialTicks, PoseStack poseStack,
