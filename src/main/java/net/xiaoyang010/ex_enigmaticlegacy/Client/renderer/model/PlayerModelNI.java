...
@OnlyIn(Dist.CLIENT)
public class PlayerModelNI<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public PlayerModelNI(ModelPart modelPart) {
    ...
    public static MeshDefinition createMesh(CubeDeformation deformation) {
        ...
        partDefinition.addOrReplaceChild("cloak", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, 0.0F, -1.0F, 10.0F, 16.0F, 1.0F, deformation), PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    public void renderEars(PoseStack poseStack, VertexConsumer vertexConsumer, int light, int overlay) {
        this.ear.copyFrom(this.head);
        this.ear.x = 0.0F;
        this.ear.y = 0.0F;
        this.ear.render(poseStack, vertexConsumer, light, overlay);
    }

    public void renderCloak(PoseStack poseStack, VertexConsumer vertexConsumer, int light, int overlay) {
        this.cloak.render(poseStack, vertexConsumer, light, overlay);
    }
