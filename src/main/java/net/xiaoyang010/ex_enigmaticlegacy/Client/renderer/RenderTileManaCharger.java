...
public class RenderTileManaCharger implements BlockEntityRenderer<TileManaCharger> {
    ...
    @Override
    public void render(TileManaCharger tile, float partialTicks, PoseStack ms, MultiBufferSource buffers,
