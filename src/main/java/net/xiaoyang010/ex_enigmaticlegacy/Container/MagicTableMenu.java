...
import net.xiaoyang010.ex_enigmaticlegacy.Container.slot.MagicTableInputSlot;
import net.xiaoyang010.ex_enigmaticlegacy.Container.slot.MagicTableOutputSlot;
...
public class MagicTableMenu extends AbstractContainerMenu {
    ...
    public boolean stillValid(@NotNull Player player) {
        return stillValid(access, player, ModBlockss.MAGIC_TABLE.get());
    }
