...
import net.xiaoyang010.ex_enigmaticlegacy.Compat.Projecte.Factory.MagicTableScreenFactory;
...
public class ModScreens {
    ...
    public static void clientLoad(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            if (ModList.get().isLoaded("projecte") && ModMenus.MAGIC_TABLE_MENU != null) {
                MagicTableScreenFactory.register();
            }
        });
    }
}
