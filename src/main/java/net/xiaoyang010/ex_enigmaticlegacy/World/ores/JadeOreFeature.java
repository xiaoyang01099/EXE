...
public class JadeOreFeature extends OreFeature {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("ex_enigmaticlegacy:jade_ore", FEATURE, new OreConfiguration(JadeOreFeature.JadeOreFeatureRuleTest.INSTANCE, ((Block) ModBlocks.JADE_ORE.get()).defaultBlockState(), 6));
