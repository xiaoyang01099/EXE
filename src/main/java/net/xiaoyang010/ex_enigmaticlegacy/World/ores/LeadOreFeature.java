...
public class LeadOreFeature extends OreFeature {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("ex_enigmaticlegacy:lead_ore", FEATURE, new OreConfiguration(LeadOreFeature.LeadOreFeatureRuleTest.INSTANCE, ((Block) ModBlocks.LEAD_ORE.get()).defaultBlockState(), 6));
