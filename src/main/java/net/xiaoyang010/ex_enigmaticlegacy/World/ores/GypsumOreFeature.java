...
public class GypsumOreFeature extends OreFeature {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("ex_enigmaticlegacy:gypsum_ore", FEATURE, new OreConfiguration(GypsumOreFeature.GypsumOreFeatureRuleTest.INSTANCE, ((Block) ModBlocks.GYPSUM_ORE.get()).defaultBlockState(), 6));
