...
public class FlowerFinderWand extends Item {
    // 魔力消耗配置
    ...
    public FlowerFinderWand() {
        super(new Properties().durability(0).setNoRepair().tab(ModTabs.TAB_EXENIGMATICLEGACY_BOTANIA));
    }
