...
public class InfinityChestEntity extends RandomizableContainerBlockEntity implements WorldlyContainer, LidBlockEntity {
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected boolean isOwnContainer(Player player) {
            if (!(player.containerMenu instanceof InfinityChestMenu)) {
                ...
                return container == InfinityChestEntity.this || container instanceof CompoundContainer && ((CompoundContainer)container).contains(InfinityChestEntity.this);
            }
        }
    };
    ...
    public static void lidAnimateTick(Level pLevel, BlockPos pPos, BlockState pState, InfinityChestEntity pBlockEntity) {
