...
public class PagedChestBlockEntity extends ChestBlockEntity implements MenuProvider, Container, LidBlockEntity {
    ...
    public PagedChestBlockEntity(BlockPos pos, BlockState state) {
        ...
        this.openersCounter = new ContainerOpenersCounter() {
            ...
            protected void onOpen(Level level, BlockPos pos, BlockState state) {
                PagedChestBlockEntity.playSound(level, pos, state, SoundEvents.CHEST_OPEN);
            }

            @Override
            protected void onClose(Level level, BlockPos pos, BlockState state) {
                PagedChestBlockEntity.playSound(level, pos, state, SoundEvents.CHEST_CLOSE);
            }

            @Override
            protected void openerCountChanged(Level level, BlockPos pos, BlockState state, int oldCount, int newCount) {
                PagedChestBlockEntity.this.signalOpenCount(level, pos, state, oldCount, newCount);
            }
            ...
            protected boolean isOwnContainer(Player player) {
                ...
                return container == PagedChestBlockEntity.this;
            }
        };
    }
